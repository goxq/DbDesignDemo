...
<div class="bottom">
    <div class="index">
        <ul class="nav bg-light nav-pills flex-column nav-justified">
            <li class="nav-item"><a class="nav-link active" href="${pageContext.request.contextPath }/BookManagementUIServlet">图书信息管理</a></li>
            <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath }/BorrowManagementUIServlet">已借图书管理</a></li>
            <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath }/ReturnManagementUIServlet">已还图书管理</a></li>
            <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath }/LogOutServlet" value="logout">退出登录</a></li>
        </ul>
    </div>
    <div class="contain" id="contain">
        <div class="tips">请从左侧导航栏选择操作</div>
    </div>
</div>
