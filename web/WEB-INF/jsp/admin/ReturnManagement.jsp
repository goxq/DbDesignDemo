...
<head>
    ...
    <!-- 引入css样式表 -->
    <link rel="stylesheet"
          href="${pageContext.request.contextPath }/resources/css/ReturnManagement.css">

    <!-- 引入JS文件 -->
    <script
            src="${pageContext.request.contextPath }/resources/js/admin/ReturnManagement.js"></script>
</head>
<body>
<div class = "book-top">
    ...
    <div class = "book_functionArea">
        <div class="book-search input-group-lg">
            <input type="text" class = "return-search-input" placeholder="直接查询学号or查询书籍号(以b开头)">
